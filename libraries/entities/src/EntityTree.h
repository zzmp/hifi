...
public:
    virtual bool getGeometryForEntity(EntityItemPointer entityItem, SittingPoints& sittingPoints, Extents& extents) = 0;
...
public:
    ...
    EntityItemGeometryService* getFBXService() const { return _geometryService; }
    void setFBXService(EntityItemGeometryService* service) { _geometryService = service; }
